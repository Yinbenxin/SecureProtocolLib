pip install --force-reinstall --no-cache-dir --extra-index-url http://devpiread:Devpiread123@10.12.0.78:13141/root/release/+simple/ --trusted-host 10.12.0.78  pyspl==0.6.0
